    ...
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
              WHY CHOOSE <span className="text-lfc-red">1-2-1 COACHING</span>?
            </h2>
            <p className="text-xl text-gray-600">Every 1-2-1 session is packed with value</p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">90 minutes of focused, professional development</p>
          </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg border border-gray-200">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Session Details</h3>
                ...
                <div className="flex justify-between items-center py-3">
                  <div className="flex items-center">
                    <User className="w-5 h-5 text-lfc-red mr-3" />
                    <div className="text-gray-900 font-semibold">Focus</div>
                  </div>
                  <div className="text-gray-600">100% personalised</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-white border-gray-200 text-center">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Ambitious Players</h3>
                <p className="text-gray-600 mb-6">Players looking to take their game to the next level with professional-standard training and personalized development.</p>
            ...
            <Card className="bg-white border-gray-200 text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6">Players wanting to improve specific aspects of their game or overcome particular challenges in their development.</p>
                <div className="space-y-2">
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="w-4 h-4 text-lfc-red mr-2" />
            ...
            <Card className="bg-white border-gray-200 text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-6">Players who need to build confidence, overcome setbacks, or develop a winning mindset both on and off the pitch.</p>
                <div className="space-y-2">
                  <div className="flex items-center text-gray-600">
                    <CheckCircle className="w-4 h-4 text-lfc-red mr-2" />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-4">
              CLIENT <span className="text-lfc-red">TESTIMONIALS</span>
            </h2>
            <p className="text-xl text-gray-600">Real results from real players and families</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
            READY TO UNLOCK YOUR <span className="text-lfc-red">POTENTIAL</span>?
          </h2>
